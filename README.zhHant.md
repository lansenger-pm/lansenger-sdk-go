...
[![Version: 0.12.1](https://img.shields.io/badge/Version-0.12.1-blue)](https://github.com/lansenger-pm/lansenger-sdk-go)
...
- **個人待辦** — 建立、編輯、查詢使用者個人待辦及資源附件；與應用待辦完全分離
...
| **組織機器人** | 在 藍信開發者中心 建立 — 可能需要組織管理員審批 |
...
// 上傳（應用/機器人 — 字串類型，支援 width/height/duration）
...
| 憑證 | 必填 | CLI 鍵名 | 說明 |
|------|------|----------|------|
| App ID | ✓ | `app_id` | 藍信應用/機器人 ID |
| App Secret | ✓ | `app_secret` | 藍信應用/機器人密鑰 |
...
store.SaveIdentityType("personal-bot")  // 可選：憑證身份類型 — personal-bot（個人機器人）/ org-app（組織應用）/ org-bot（組織機器人）
