...
const (
	...
	QuestionnaireStatusDraft          = 1
	QuestionnaireStatusOngoing        = 2
	QuestionnaireStatusWithdrawn      = 3
	QuestionnaireStatusFinished       = 4
	QuestionnaireStatusReadyToPublish = 5
	QuestionnaireScopeInternal        = 1
