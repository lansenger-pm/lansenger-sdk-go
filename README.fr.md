...
| API Gateway URL | ✓ | `api_gateway_url` | Point d'accès API |
...
| `LANSENGER_API_GATEWAY_URL` | ✓ | URL Gateway API | — |
...
store.SaveIdentityType("personal-bot")  // optionnel : type d'identité — personal-bot / org-app / org-bot
...
├── videoconferences.go    # Videoconference (视频会议开放能力)
