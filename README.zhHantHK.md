...
[![Version: 0.5.0](https://img.shields.io/badge/Version-0.4.1-blue)](https://github.com/lansenger-pm/lansenger-sdk-go)
...
- **訊息傳送** — 3 種私聊通道（機械人、官方帳號、使用者代發）+ 群聊，支援所有訊息類型、@提及、人類/機械人發送者身份
...
|----------|----------------------------|
| **個人機械人** | 藍信桌面端 → 聯絡人 → 智慧機械人 → 個人機械人 → 點擊 ℹ️ 圖示（流動端不顯示憑證） |
| **藍信應用** | 在 [藍信開發者中心](https://dev.lanxin.cn) 建立 — 可能需要組織管理員審批 |
| **組織機械人** | 在 [藍信開發者中心](https://dev.lanxin.cn) 建立 — 可能需要組織管理員審批 |
...
| API Gateway URL | ✓ | `api_gateway_url` | API 網關地址（預設：`https://open.e.lanxin.cn/open/apigw`） |
...
| `LANSENGER_API_GATEWAY_URL` | ✗ | API 網關地址 | `https://open.e.lanxin.cn/open/apigw` |
